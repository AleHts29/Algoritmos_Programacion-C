/*
29:
Escribir un programa que permita ingresar n números enteros en un arreglo llamado numeros y despliegue el conjunto de sus elementos, así como la suma de ellos.
*/
