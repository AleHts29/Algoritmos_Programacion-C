...
#define MAXWELL_MANUFACTURE_ID 1
#define SONY_MANUFACTURE_ID 1
#define VERBATIM_MANUFACTURE_ID 1
...
int main(void) {
    ...
    printf("Ingrese ID: \n");
    printf("%d - %s \n", MAXWELL_MANUFACTURE_ID, MAXWELL_MAMING);
    printf("%d - %s \n", SONY_MANUFACTURE_ID, SONY_MAMING);
    printf("%d - %s \n", VERBATIM_MANUFACTURE_ID, VERBATIN_MAMING);
